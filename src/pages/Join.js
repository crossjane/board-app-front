...
const Join = () => {
    ...
    const usernameCheck = useCallback(async () => {
        try {
            ...
            const response = await axios.post('http://211.188.51.227:9090/members/username-check', {
    ...
    const nicknameCheck = useCallback(async () => {
        try {
            ...
            const response = await axios.post('http://211.188.51.227:9090/members/nickname-check', {
